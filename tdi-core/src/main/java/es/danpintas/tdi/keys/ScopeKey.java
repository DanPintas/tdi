 ...
 * @author danpintas
 */
public class ScopeKey extends AbstractKey<Class<? extends Annotation>, Function<InstanceProvider, Provider>> {
     ...
     */
    public ScopeKey(Class<? extends Annotation> annotation, Function<InstanceProvider, Provider> provision) {
