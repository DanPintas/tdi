...
public final class Types {
     ...
     * @return {@link Class} associated to {@code Type}.
     */
    ...
    public static List<Method> getMethods(Class<?> type) {
        ...
        Collections.addAll(methods, array);
        return methods;
    }
     ...
     * @return true if {@code sub} overrides {@code method}, false otherwise.
     */
